...
import 'package:hutech_go/services/location_service.dart';
import 'package:hutech_go/services/cost_calculation_service.dart';
import 'package:hutech_go/services/direction_service.dart';
...
class _Booking extends State<Booking> {
  ...
  void initState() {
    super.initState();
    LocationService().requestLocationPerrmission();
    getCurrentLocation();
                          ...
                          checkBoxButtonValues: (value) {
                            if (value != null) {
                              setState(() async {
                                ...
                                addMarker();
                                final _directions = await DirectionService()
                                    .getDirections(
                                        origin: LatLng(
